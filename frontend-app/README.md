...
브라우저에서 `http://localhost:11001`을 엽니다. 앱인토스 앱은 `11001` 포트, 기존 Next.js 웹 버전은 `11000` 포트에서 확인합니다. 백엔드는 호스트에 포트를 공개하지 않고 Compose 내부의 `backend:8080`으로만 연결됩니다. 종료할 때는 다음을 실행합니다.
